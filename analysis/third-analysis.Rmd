...
![<span style="font-size: smaller;">Custom NanoLuciferase plasmid from Dr. Shane Denecke (Dr. Michael Povelones Lab)</span>](assets/plasmid.png){ width=300px }
...
Images created with [biorender.com](biorender.com)
