...
<div style="text-align: center;">
    ![<span style="font-size: smaller;">Custom NanoLuciferase plasmid from Dr. Shane Denecke (Dr. Michael Povelones Lab)</span>](assets/picture.png){ width=200px }
</div>


![<span style="font-size: smaller;">Custom NanoLuciferase plasmid from Dr. Shane Denecke (Dr. Michael Povelones Lab)</span>](assets/plasmid.png){ width=200px }
...
[Swimming cell growth is not affected by SF exines, is initial attachment affected?](fourth-analysis.html)
