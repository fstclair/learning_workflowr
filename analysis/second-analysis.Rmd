...
# S <- aov(AA_08_WH_S_R$V2~AA_08_WH_S_R$V1)
# summary(S)
...
# #Tukey test
# HSD.S <- HSD.test(S, "AA_08_WH_S_R$V1")
# HSD.S
```
...
# 
# AA <- aov(AA_08_WH_IR_R$V2~AA_08_WH_IR_R$V1)
# summary(AA)
# #run shapiro test on residuals
# res <- residuals(AA)
# res
...
# library(agricolae)
# ?HSD.test
# HSD.AA <- HSD.test(AA, "AA_08_WH_IR_R$V1")
# HSD.AA
...
# 
# MR <- aov(AA_08_WH_MR_R$V2~AA_08_WH_MR_R$V1)
# summary(MR)
# #run shapiro test on residuals
# res <- residuals(MR)
# res
...
# #Tukey test
# HSD.MR <- HSD.test(MR, "AA_08_WH_MR_R$V1")
# HSD.MR
...
## [Using WH strain from now on, so does pollen effect swimming cell growth?](third-analysis.html)
